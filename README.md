...
For details on environment variables, `opencode-im-bridge.jsonc`, and advanced configuration options, see the separate [Configuration Guide (CONFIGURATION.md)](CONFIGURATION.md).
